...
class AdvanceFormPrioritas2 extends StatefulWidget {
  const AdvanceFormPrioritas2({super.key});

  @override
  State<AdvanceFormPrioritas2> createState() => _AdvanceFormPrioritas2State();
}

class _AdvanceFormPrioritas2State extends State<AdvanceFormPrioritas2> {
    ...
    return Column(children: [
      ...
      TextFormField(
        controller: _phoneController
          ..text = listPhone.contains("+62") ? listPhone : "+62 ${listPhone}",
        // initialValue: '+62',
        maxLength: 20,
        decoration: const InputDecoration(
          labelText: 'Nomor',
