...
import 'package:flutter_animation/eksplorasi/detail_edit.dart';
                ...
                trailing: SizedBox(
                  ...
                  child: Row(
                    children: [
                      InkWell(
                          onTap: () {
                            // log("Kontak Terpilih adalah ${contactProvider.contacts[index].name}");
                            // log("Masuk Ke halaman detail update kontak");
